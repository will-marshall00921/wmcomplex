// wmcomplex -- wmcomplex_test_mul.cpp
// Author: Will Marshall
// Created: 4/15/2026, 7:51:01 PM
...
static const wm::TestLogger logger("wmcomplex_test_mul");
...
inline std::pair<bool, std::string> test_logic() noexcept {
  ...
  try {
    ...
    const double expected_real = ((re_1 * re_2) - (im_1 * im_2));
    const double expected_imag = ((re_1 * im_2) + (im_1 * re_2));
...
int main() {
  const std::string TEST_FRIENDLY_NAME = "complex multiplication";
