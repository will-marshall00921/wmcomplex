// wmcomplex -- wmcomplex_test_add.cpp
// Author: Will Marshall
// Created: 4/15/2026, 7:24:11 PM
...
static const wm::TestLogger logger("wmcomplex_test_add");
...
int main() {
  const std::string TEST_FRIENDLY_NAME = "complex addition";
